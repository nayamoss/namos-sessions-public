...
describe("shared control sizing", () => {
  it("keeps regular and compact controls readable at the compact product density", () => {
  ...
  it("gives form fields compact, readable control dimensions", () => {
  ...
  it("uses the documented compact density scale", () => {
