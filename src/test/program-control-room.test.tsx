...
describe("Program Control Room", () => {
  it("renders every operational category and exact record links", () => {
    ...
    for (const heading of ["Decisions waiting", "Incomplete reviews", "Unsent acceptance emails", "Overdue speaker tasks", "Missing headshots or slides", "Unscheduled accepted sessions", "Room or speaker conflicts", "Publication blockers"])
    ...
    expect(screen.getAllByText("All clear")).toHaveLength(7);
  });
