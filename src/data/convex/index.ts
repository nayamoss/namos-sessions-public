...
export const convexFunction: Record<
  Exclude<ReadOperation | WriteOperation, "publicForms.submit">,
  string
> = {
  ...
  "crm.sources.startOAuth": "crmSourceActions:startOAuth",
  "crm.sources.finishOAuth": "crmSourceActions:finishOAuth",
  "crm.list": "crm:listForEvent",
  "crm.segments.list": "crm:listSegmentsForEvent",
  "crm.save": "crm:saveForEvent",
  "crm.segments.save": "crm:saveSegmentForEvent",
  "crm.assignToEvent": "crm:assignToEvent",
  "crm.unlinkFromEvent": "crm:unlinkFromEvent",
  "crm.archive": "crm:archiveForEvent",
  "crm.bulkStage": "crm:bulkStageForEvent",
  "crm.backfillEvent": "crm:backfillEvent",
  "controlRoom.get": "controlRoom:get",
  "events.list": "events:list",
  "events.listMine": "events:listMine",
  "events.listForPortal": "events:listForPortal",
  "events.portalSpeakerIdentity": "events:portalSpeakerIdentity",
  "events.get": "events:get",
  "events.getBySlug": "events:getBySlug",
  "events.rooms.list": "events:listRooms",
  "events.tracks.list": "events:listTracks",
  "files.getUrl": "files:getUrl",
  "speakerNotes.list": "speakerNotes:list",
  "events.save": "events:save",
  "events.duplicate": "events:duplicate",
  "events.remove": "events:remove",
  "events.rooms.save": "events:saveRoom",
  "events.rooms.remove": "events:removeRoom",
  "events.tracks.save": "events:saveTrack",
  "events.tracks.remove": "events:removeTrack",
  "eventMembers.list": "eventMembers:list",
  "eventMembers.canManage": "eventMembers:hasOrganizerAccess",
  "eventMembers.invite": "eventInviteActions:invite",
  "eventMembers.resend": "eventInviteActions:resend",
  "eventMembers.claimPending": "eventMembers:claimPending",
  "eventMembers.add": "eventMembers:add",
  "eventMembers.remove": "eventInviteActions:remove",
  "tags.list": "tags:list",
  "tags.create": "tags:create",
  "tags.rename": "tags:rename",
  "tags.remove": "tags:remove",
  "speakerNotes.create": "speakerNotes:create",
  "speakerNotes.remove": "speakerNotes:remove",
  "files.generateUploadUrl": "files:generateUploadUrl",
  "forms.list": "forms:list",
  "forms.fields": "forms:fields",
  "forms.listFields": "forms:listFields",
  "forms.save": "forms:save",
  "forms.saveField": "forms:saveField",
  "forms.createFromTemplate": "forms:createFromTemplate",
  ...
  "submissions.updateBySpeaker": "submissions:updateBySpeaker",
  "speakers.list": "speakers:list",
  "speakers.create": "speakers:create",
  "speakers.setConfirmationStatus": "speakers:setConfirmationStatus",
  "speakers.getMine": "speakers:getMine",
  "speakers.headshotUrl": "speakers:headshotUrl",
  "speakers.updateProfile": "speakers:updateProfile",
  "speakers.requestHeadshotUpload": "speakers:requestHeadshotUpload",
  "speakers.saveHeadshot": "speakers:saveHeadshot",
  "speakers.documents.requestUpload": "speakerDocuments:requestUpload",
  "speakers.documents.save": "speakerDocuments:save",
  "speakers.documents.list": "speakerDocuments:list",
  "speakers.documents.remove": "speakerDocuments:remove",
  "evaluations.list": "evaluations:list",
  "evaluations.save": "evaluations:save",
  "evaluations.plans.list": "evaluations:listPlans",
  "evaluations.plans.save": "evaluations:savePlan",
  "evaluations.assignments.list": "evaluations:listAssignments",
  ...
  "agenda.listForSpeaker": "agenda:listForSpeaker",
  "agenda.detectConflicts": "agenda:detectConflicts",
  "agenda.checkPlacement": "agenda:checkPlacement",
  ...
  "taskTemplates.update": "taskTemplates:update",
  "taskTemplates.remove": "taskTemplates:remove",
  "taskTemplates.setDefault": "taskTemplates:setDefault",
  "taskTemplates.ensureStarters": "taskTemplates:ensureStarters",
  ...
  "publicEmbeds.get": "publicEmbeds:get",
  "publicEmbeds.list": "publicEmbeds:list",
  ...
  "portalForms.submit": "portalFormResponses:submit",
  "portalResources.listAdmin": "portalResources:listAdmin",
  "portalResources.listPublished": "portalResources:listPublished",
  "portalResources.save": "portalResources:save",
  "portalResources.reorder": "portalResources:reorder",
  "portalResources.remove": "portalResources:remove",
  "organizers.list": "organizers:list",
  "organizers.getMine": "organizers:getMine",
  "organizers.isCurrentUserOrganizer": "organizers:isCurrentUserOrganizer",
  "organizers.hasAdminAccess": "organizers:hasAdminAccess",
  "organizations.createForCurrentUser": "organizations:createForCurrentUser",
  "organizations.listMine": "organizations:listMine",
  "organizations.getMine": "organizations:getMine",
  "organizations.rename": "organizations:rename",
  "organizers.completeOnboarding": "organizers:completeOnboarding",
  "organizers.add": "organizers:add",
  "organizers.remove": "organizers:remove",
  "speakers.bulkImport": "speakers:bulkImport",
  "profiles.getMine": "userProfiles:getMine",
  "profiles.save": "userProfiles:save",
  "emailIntegrations.status": "emailIntegrations:status",
  "emailIntegrations.save": "emailIntegrationsActions:save",
  ...
  "contentIntegrations.connectAirtable":
    "contentIntegrationsActions:connectAirtable",
  "contentIntegrations.importAirtable":
    "contentIntegrationsActions:importAirtable",
  "contentIntegrations.startOAuth": "contentIntegrationsActions:startOAuth",
  "contentIntegrations.listNotionOAuthDatabases":
    "contentIntegrationsActions:listNotionOAuthDatabases",
  "contentIntegrations.finishNotionOAuth":
    "contentIntegrationsActions:finishNotionOAuth",
  "contentIntegrations.listAirtableOAuthBases":
    "contentIntegrationsActions:listAirtableOAuthBases",
  "contentIntegrations.listAirtableOAuthTables":
    "contentIntegrationsActions:listAirtableOAuthTables",
  "contentIntegrations.finishAirtableOAuth":
    "contentIntegrationsActions:finishAirtableOAuth",
  "contentIntegrations.connectSanity":
    "contentIntegrationsActions:connectSanity",
  "contentIntegrations.publishSanity":
    "contentIntegrationsActions:publishSanity",
  "contentIntegrations.disconnect": "contentIntegrationsActions:disconnect",
  ...
  "comms.sendCrmCampaign": "commsActions:sendCrmCampaign",
  "apiKeys.list": "apiKeys:list",
  "apiKeys.auditLog": "apiKeys:auditLog",
  "apiKeys.generate": "apiKeysActions:generate",
  "apiKeys.revoke": "apiKeys:revoke",
  "activity.list": "activity:list",
  "sponsors.list": "sponsors:list",
  "sponsors.get": "sponsors:get",
  "sponsors.create": "sponsors:create",
  "sponsors.update": "sponsors:update",
  "sponsors.remove": "sponsors:remove",
  "sponsorTiers.list": "sponsorTiers:list",
  "sponsorTiers.create": "sponsorTiers:create",
  "sponsorTiers.update": "sponsorTiers:update",
  "sponsorTiers.reorder": "sponsorTiers:reorder",
  "sponsorTiers.remove": "sponsorTiers:remove",
  "sponsorContacts.listBySponsor": "sponsorContacts:listBySponsor",
  "sponsorContacts.create": "sponsorContacts:create",
  "sponsorContacts.update": "sponsorContacts:update",
  "sponsorContacts.remove": "sponsorContacts:remove",
  "taskTemplates.applyToSponsor": "taskTemplates:applyToSponsor",
  "agentRuns.canUse": "agentRuns:canUse",
  "agentRuns.suggestions": "agentRuns:suggestions",
  "agentRuns.list": "agentRuns:list",
  "agentRuns.get": "agentRuns:get",
  "agentRuns.create": "agentRuns:create",
  "agentRuns.respond": "agentRuns:respond",
  "agentRuns.retry": "agentRuns:retry",
  "agentRuns.cancel": "agentRuns:cancel",
  "agentRuns.approveTaskProposal": "agentRuns:approveTaskProposal",
  "agentRuns.approveMessageProposal": "agentRuns:approveMessageProposal",
  "agentRuns.rejectProposal": "agentRuns:rejectProposal",
  "agentProviderSettings.status": "agentProviderSettings:status",
  "agentProviderSettings.saveManaged":
    "agentProviderSettingsActions:saveManaged",
  "agentProviderSettings.saveByok": "agentProviderSettingsActions:saveByok",
  "agentProviderSettings.disconnectByok":
    "agentProviderSettingsActions:disconnectByok",
...
const convexActions = new Set<WriteOperation>([
  "eventMembers.invite",
  "eventMembers.resend",
  "eventMembers.remove",
  ...
  "crm.sources.connect",
  "crm.sources.sync",
  "crm.sources.startOAuth",
  "crm.sources.finishOAuth",
]);
...
function documentRow(document: unknown): ConvexDocument {
  if (
    ...
    throw new Error("Convex returned an invalid document.");
  return document as ConvexDocument;
}

function documentRows(value: unknown): ConvexDocument[] {
  if (!Array.isArray(value))
    throw new Error("Convex returned an invalid document list.");
...
export function normalize(
  ...
  const row = (document: unknown) => {
    const { _id, _creationTime: _drop, ...rest } = documentRow(document);
    return { ...rest, id: _id };
  };
  if (!value) return value;
  if (
    operation === "events.list" ||
    operation === "events.listMine" ||
    operation === "events.listForPortal" ||
    operation === "crm.list" ||
    operation === "crm.segments.list" ||
    operation === "crm.sources.list"
  )
  ...
  if (operation === "agentRuns.get") {
    ...
    return {
      run: row(detail.run),
      events: documentRows(detail.events).map(row),
      proposals: documentRows(detail.proposals).map(row),
    };
  }
  if (
    operation === "events.get" ||
    operation === "events.getBySlug" ||
    operation === "emailIntegrations.status" ||
    operation === "contentIntegrations.status" ||
    operation === "organizers.getMine" ||
    operation === "organizations.getMine" ||
  ...
  if (
    ...
    operation === "eventMembers.list" ||
    operation === "tags.list" ||
    operation === "speakers.documents.list" ||
    operation === "speakerNotes.list" ||
    operation === "agenda.list" ||
    operation === "agenda.listForSpeaker" ||
    operation === "evaluations.list" ||
    operation === "evaluations.plans.list" ||
    operation === "evaluations.assignments.list" ||
    operation === "tasks.list" ||
    operation === "taskTemplates.list" ||
    operation === "availability.list" ||
    operation === "organizers.list" ||
    operation === "organizations.listMine" ||
  ...
  if (
    ...
    operation === "sponsorTiers.list" ||
    operation === "sponsorContacts.listBySponsor"
  )
    return documentRows(value).map((document) => ({
      ...row(document),
      ...(document.tier && typeof document.tier === "object"
        ? { tier: row(document.tier) }
        : {}),
      ...(document.primaryContact && typeof document.primaryContact === "object"
        ? { primaryContact: row(document.primaryContact) }
        : {}),
    }));
  if (operation === "sponsors.get") {
    const document = documentRow(value);
    return {
      ...row(document),
      ...(document.tier && typeof document.tier === "object"
        ? { tier: row(document.tier) }
        : {}),
      contacts: Array.isArray(document.contacts)
        ? document.contacts.map(row)
        : [],
      tasks: Array.isArray(document.tasks) ? document.tasks.map(row) : [],
      submissions: Array.isArray(document.submissions)
        ? document.submissions.map((submission) => ({
            ...row(submission),
            speakerIds: documentRow(submission).speakerId
              ? [documentRow(submission).speakerId]
              : [],
            tagIds: Array.isArray(documentRow(submission).tagIds)
              ? documentRow(submission).tagIds
              : [],
          }))
        : [],
    };
  ...
  if (operation === "forms.list")
    return documentRows(value).map((document) => ({
      ...
      isOpen: document.status === "open",
    }));
  if (operation === "forms.fields" || operation === "forms.listFields")
    return documentRows(value).map(row);
  ...
  if (operation === "submissions.list")
    return documentRows(value).map((document) => ({
      ...row(document),
      speakerIds: document.speakerId ? [document.speakerId] : [],
  ...
  if (operation === "comms.list")
    return documentRows(value).map((document) => ({
      ...row(document),
      type: document.channel,
    }));
  if (operation === "comms.listDrafts") return documentRows(value).map(row);
...
export function normalizeInput(
  ...
  if (operation === "events.save" && "id" in input) {
    ...
    const fields = Object.fromEntries(
      Object.entries(event).filter(([key]) => EVENT_SAVE_FIELDS.has(key)),
    );
...
export async function submitPublicFormAtEdge(
  ...
  if (!response.ok) {
    ...
    if (result.error === "verification_unavailable")
      throw new Error("Submission verification is temporarily unavailable.");
    if (result.error === "form_closed")
      throw new Error("This submission form is closed.");
    if (result.error === "submission_limit")
      throw new Error("You have reached this form's submission limit.");
    throw new Error("Submission service unavailable.");
  }
  return {
    ...(typeof result.speakerId === "string"
      ? { speakerId: result.speakerId }
      : {}),
  } satisfies PublicFormSubmissionResult;
}
...
function createConvexTransport(getToken?: TokenGetter): DataTransport {
  ...
  const getClient = () => {
    if (!client) {
      ...
      if (!url)
        throw new Error(
          "VITE_CONVEX_URL is required when VITE_DATA_BACKEND=convex",
        );
  ...
  const authedClient = async () => {
    ...
    else instance.clearAuth();
    return instance;
  };
  return {
    read: async (operation, input) =>
      normalize(
        operation,
        await (
          await authedClient()
        ).query(
          convexFunction[operation] as never,
          normalizeInput(operation, input as Record<string, unknown>) as never,
        ),
      ) as never,
    write: async (operation, input) => {
      if (operation === "publicForms.submit") {
        return submitPublicFormAtEdge(
          (input as { input: PublicFormSubmissionInput }).input,
          await getToken?.(),
        ) as never;
      }
      const client = await authedClient();
      const name = convexFunction[
        operation as Exclude<WriteOperation, "publicForms.submit">
      ] as never;
      ...
      return normalize(
        operation,
        await (convexActions.has(operation)
          ? client.action(name, args)
...
export function createConvexRepo(
