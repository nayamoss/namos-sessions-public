...
export function AgendaMoveControl({ id, title, roomId: initialRoom, startTime, rooms, timeZone, onMove, compact = false }: { id: string; title: string; roomId: string; startTime: number; rooms: Room[]; timeZone: string; onMove: (id: string, roomId: string, startTime: number) => Promise<void>; compact?: boolean }) {
