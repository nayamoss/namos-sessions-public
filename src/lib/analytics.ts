...
const staticRoutes = new Set(["/", "/events", "/onboarding", "/portal", "/portal/profile", "/portal/forms", "/portal/tasks", "/api-docs", "/sign-in", "/sign-up", "/settings/organization", "/dashboard", "/dashboard/speakers", "/program/forms", "/program/speakers", "/program/abstracts", "/program/evaluation", "/program/agenda", "/program/communications", "/program/availability", "/portals/tasks", "/portals/forms", "/settings/event", "/settings/library", "/settings/task-templates", "/settings/email", "/settings/api"]);
